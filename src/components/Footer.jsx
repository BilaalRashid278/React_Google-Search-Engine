...
const Footer = () => {
  ...
  return (
    <div className="bg-[#f2f2f2]">
      <div className="flex px-[15px] py-[15px] md:px-[30px] border-b border-[#dadce0]">
      ...
      <div className="flex flex-col md:flex-row justify-between py-3 md:py-0 md:px-[15px]">
        ...
        return  <span key={index} className="text-[#70757a] text-[12px] md:text-[14px] leading-none p-[10px] md:p-[15px] hover:underline cursor-pointer">
          {menu}
        </span>
        })}
        </div>
